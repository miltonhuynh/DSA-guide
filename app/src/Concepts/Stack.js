...
class Stack {
  ...
  return (
    <div class="Concept_page">
      ...
      <main>
        <ul>
          <section><li>A last in first out data structure, the last element added to the stack will be the first element removed from the stack.</li></section>
          <section><li>Stacks are used to handle function invocations (the call stack), for operations like undo/redo, and for routing and much more</li></section>
          <section><li>Not a built in structure in JavaScript</li></section>
          <section>
            <li>
              Big O of Stacks
              <ul>
          ...
          <section><li>In addition to push and pop, unshift and shift can also be used to implement a stack in an array, these add and remove from the beginning of the array instead of the end; however, it is better to push and pops to avoid re-indexing every other item</li></section>
          <section><li>Linked lists can also be used to implement a Stack data structure</li></section>
          <section>
