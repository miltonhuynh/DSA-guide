    ...
    <div class="Concept_page">
      ...
      <div class="Container font-m">
        ...
        <ul>
          ...
          <br/>
          <li>Prim's algorithm is a greedy algorithm which selects the best option at each step</li><br/>
          <li>
          ...
          <li>The time complexity Of Kruskal's Algorithm is: O(E log E).</li>
        </ul>
